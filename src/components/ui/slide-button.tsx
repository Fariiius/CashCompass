  ...
  const handleSubmit = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      if (onComplete) {
        setTimeout(() => {
          onComplete()
          // Optionally reset status if you want it to be reusable
          // setStatus("idle")
        }, 800)
      }
    }, 1500)
...
export const SlideButton = forwardRef<HTMLButtonElement, SlideButtonProps>(
  ({ className, onComplete, text = "View Publication", ...props }, ref) => {
    ...
    return (
      <div className="flex flex-col items-center gap-2">
        ...
        >
          ...
          <AnimatePresence key="slide-button-presence">
            {!completed && (
              <motion.div
                ref={dragHandleRef}
                drag="x"
          ...
          <AnimatePresence key="completed-presence">
            {completed && (
              <motion.div
